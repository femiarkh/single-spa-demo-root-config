...
const url = `https://single-spa-demo-femiarkh.s3.eu-west-1.amazonaws.com/%40femiarks/root-config/${process.env.TRAVIS_COMMIT}/femiarks-root-config.js`;
  ...
  .get(url, (res) => {
    ...
    if (res.statusCode >= 200 && res.statusCode < 300) {
      if (
        ...
        const moduleName = `@femiarks/root-config`;
